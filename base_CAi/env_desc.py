# Data lake dictionary with detailed descriptions (Drug Discovery / Medicinal Chemistry focused)
data_lake_dict = {
    # === 药物发现核心数据 ===
...
# Library content dictionary (Drug Discovery / Medicinal Chemistry focused)
