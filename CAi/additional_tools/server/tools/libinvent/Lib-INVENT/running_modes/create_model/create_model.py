...
class CreateModel:
    ...
    def run(self):
        ...
        scaffold_list, decoration_list = zip(
        ...
        self._log.info(
            "Scaffold vocabulary contains %d tokens: %s",
            vocabulary.len_scaffold(),
            vocabulary.scaffold_vocabulary.tokens(),
        )
        self._log.info(
            "Decorator vocabulary contains %d tokens: %s",
            vocabulary.len_decoration(),
            vocabulary.decoration_vocabulary.tokens(),
        )
