...
def main():
    ...
    try:
        ...
        agent = A1(llm='gpt-4.1', source='OpenAI', load_datalake=False)
    ...
    test_cases = [
        ...
        # CELLxGENE tests
        {
            ...
            "query": "Find CD 8 T cell gene expression datasets in cell by gene census",
            "description": "Test CELLxGENE Census query for brain single-cell data"
        },
        {
            "function": "query_cellxgene_census",
            "query": "Search for highly variable genes in mouse brain data and specify their cell type from single-cell data",
            "description": "Test CELLxGENE Census query for immune cell data"
        },
