...
class humanity_last_exam(base_task):
    ...
    def __init__(self, category = 'Biology/Medicine', answer_type = 'multipleChoice'):
        ...
        df = pd.read_parquet('/dfs/scratch1/serenazhang/BioAgentOS/bioagentos/data/hle/test_sampled_biology_medicine.parquet')
