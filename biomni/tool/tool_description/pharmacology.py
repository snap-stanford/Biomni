description = [
    ...
    # ChEMBL Beaker Cheminformatic Tools
    {
        "description": "Standardize chemical structures using ChEMBL Beaker API for cheminformatic analysis and validation.",
        "name": "standardize_chemical_structure",
        "optional_parameters": [
            {
                "default": "standardize",
                "description": "Standardization operation type: 'standardize', 'check', 'exclude', or 'getParent'",
                "name": "operation",
                "type": "str",
            },
        ],
        "required_parameters": [
            {
                "default": None,
                "description": "Chemical structure in SMILES or MOL file format",
                "name": "smiles_or_molfile",
                "type": "str",
            },
        ],
    },
    {
        "description": "Calculate comprehensive physicochemical properties using ChEMBL Beaker API with RDKit and ChEMBL descriptors.",
        "name": "calculate_physicochemical_properties_chembl",
        "optional_parameters": [
            {
                "default": "all",
                "description": "Type of descriptors to calculate: 'chembl' for ChEMBL descriptors only, 'all' for both ChEMBL and RDKit descriptors",
    ...
    {
        "description": "Convert chemical structures between different molecular formats using ChEMBL Beaker API (SMILES, InChI, InChIKey, MOL files, SMARTS).",
        "name": "convert_chemical_format",
        "optional_parameters": [
            {
                "default": 300,
                "description": "Size parameter for SVG output generation",
                "name": "size",
                "type": "int",
            },
        ],
        "required_parameters": [
            {
                "default": None,
                "description": "Chemical structure in the input format",
                "name": "input_structure",
                "type": "str",
            },
            {
                "default": None,
                "description": "Input format: 'smiles', 'inchi', 'ctab', or 'molfile'",
                "name": "input_format",
                "type": "str",
            },
            {
                "default": None,
                "description": "Output format: 'smiles', 'inchi', 'inchikey', 'ctab', 'svg', or 'smarts'",
                "name": "output_format",
                "type": "str",
            },
        ],
    ...
    {
        "description": "Generate molecular images and 2D coordinates using ChEMBL Beaker API for visualization and analysis.",
        "name": "generate_molecular_image",
        "optional_parameters": [
            {
                "default": "svg",
                "description": "Output format: 'svg' for vector graphics or '2d' for 2D coordinates",
                "name": "output_format",
                "type": "str",
            },
            {
    ...
    {
        "description": "Analyze structural alerts and toxicophores in chemical compounds using ChEMBL Beaker API for safety assessment.",
        "name": "analyze_structural_alerts",
        "optional_parameters": [],
        "required_parameters": [
            {
                "default": None,
    ...
    {
        "description": "Check the operational status and availability of ChEMBL Beaker cheminformatic services.",
        "name": "check_chembl_beaker_status",
        "optional_parameters": [],
        "required_parameters": [],
    },
    {
        "description": "Canonicalize SMILES strings using ChEMBL Beaker API to ensure consistent molecular representation.",
        "name": "canonicalize_smiles_string",
        "optional_parameters": [],
        "required_parameters": [
            {
                "default": None,
                "description": "SMILES string to canonicalize",
                "name": "smiles",
                "type": "str",
            },
        ],
