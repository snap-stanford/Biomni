description = [
    ...
    },
    {
        ...
        "optional_parameters": [
            {"name": "output_dir", "type": "str", "description": "Directory to save downloaded files (defaults to workspace/geo_data/gpl_annotations)", "default": None},
            {"name": "gene_symbol_column", "type": "str", "description": "Column name containing gene symbols. If None, auto-detects from common column names.", "default": None},
        ],
        "required_parameters": [
            {
                "name": "gpl_id",
    ...
    },
    {
        ...
        "optional_parameters": [
            {"name": "gpl_id", "type": "str", "description": "GPL platform ID to download annotations from (if probe_to_gene not provided)", "default": None},
            {"name": "probe_to_gene", "type": "dict", "description": "Pre-computed probe-to-gene mapping dict", "default": None},
            {"name": "aggregation", "type": "str", "description": "Method to aggregate multiple probes per gene: 'mean', 'median', 'max', 'sum'", "default": "mean"},
        ],
        "required_parameters": [
            {
