description = [
    ...
    {
        "description": "Query ClinicalTrials.gov for studies using natural language, direct endpoint, or structured parameters. At least one query parameter is required: 'prompt' (natural language), 'endpoint' (direct URL), or structured parameters ('term', 'condition', 'intervention', 'status').",
        "name": "query_clinicaltrials",
        "optional_parameters": [
            {
                "name": "prompt",
                "type": "str",
                "description": "Natural language query about clinical trials (required if no other query params provided)",
                "default": None,
            },
            {
                "name": "endpoint",
                "type": "str",
                "description": "Direct API path or full URL to ClinicalTrials.gov endpoint (required if no other query params provided)",
                "default": None,
            },
            {
                "name": "term",
                "type": "str",
                "description": "Free-text search term (required if no other query params provided)",
                "default": None,
            },
            {
                "name": "status",
                "type": "str",
                "description": "Overall recruitment status filter, e.g., RECRUITING (required if no other query params provided)",
                "default": None,
            },
            {
                "name": "condition",
                "type": "str",
                "description": "Condition/disease filter (required if no other query params provided)",
                "default": None,
            },
            {
                "name": "intervention",
                "type": "str",
                "description": "Intervention filter (required if no other query params provided)",
                "default": None,
            },
            {
                "name": "location",
...
# To make local gwas_catalog.pkl instead query the API
description = [
    desc for desc in description if desc["name"] not in ["query_gwas_catalog"]
]
