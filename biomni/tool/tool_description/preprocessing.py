        ...
        "required_parameters": [
            {
                "name": "data",
                "type": "pd.DataFrame",
                "description": "Input dataset to clean"
            }
        ],
        "optional_parameters": [
            {
        ...
        "required_parameters": [
            {
                "name": "data",
                "type": "pd.DataFrame", 
                "description": "Input dataset for outlier removal"
            }
        ],
        "optional_parameters": [
            {
        ...
        "required_parameters": [
            {
                "name": "data", 
                "type": "pd.DataFrame",
                "description": "Input dataset to normalize"
            }
        ],
        "optional_parameters": [
            {
    ...
    },
    {
        ...
        "optional_parameters": [
            ...
            },
            {
                "name": "method",
                "type": "str",
                "description": "Encoding method: 'label', 'onehot'",
                "default": "label"
            }
        ],
        "return_type": "tuple",
    ...
    },
    {
        ...
        "required_parameters": [
            ...
            },
            {
                "name": "processed_data", 
                "type": "pd.DataFrame",
                "description": "Dataset after preprocessing"
            },
            {
        ...
        "required_parameters": [
            {
                "name": "data",
                "type": "pd.DataFrame",
                "description": "Dataset to analyze for quality issues"
            }
        ],
        "optional_parameters": [
            {
        ...
        "required_parameters": [
            {
                "name": "data",
                "type": "pd.DataFrame",
                "description": "Input dataset to preprocess"
            }
        ],
        "optional_parameters": [
            {
