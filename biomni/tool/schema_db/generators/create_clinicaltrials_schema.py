...
clinicaltrials_schema = {
    ...
    "endpoints": {
        "version": {"description": "Get API version information", "url": "/version", "method": "GET"},
        "studies": {
        ...
        "studies_by_id": {
            ...
            "url": "/studies/{nctId}",
            "method": "GET",
            "parameters": {"format": "Response format (json, csv)", "fields": "Specific fields to include in response"},
        },
        "stats": {
    ...
    "study_phases": ["EARLY_PHASE1", "PHASE1", "PHASE1_PHASE2", "PHASE2", "PHASE2_PHASE3", "PHASE3", "PHASE4", "NA"],
    ...
    "examples": {
        "search_cancer": {"endpoint": "/studies", "parameters": {"query.cond": "cancer", "pageSize": 10}},
        "search_covid": {
            "endpoint": "/studies",
            "parameters": {"query.cond": "COVID-19", "filter.overallStatus": "RECRUITING"},
        },
        "get_specific_study": {"endpoint": "/studies/NCT05013879", "parameters": {}},
        "search_by_intervention": {"endpoint": "/studies", "parameters": {"query.intr": "aspirin", "pageSize": 20}},
        "recruiting_phase3": {
            "endpoint": "/studies",
            "parameters": {"filter.overallStatus": "RECRUITING", "filter.phase": "PHASE3", "pageSize": 50},
        },
    },
    "pagination": {
